...
class SearchByButtonScreen extends StatefulWidget {
  ...
  @override
  _SearchByButtonScreenState createState() => _SearchByButtonScreenState();
}

class _SearchByButtonScreenState extends State<SearchByButtonScreen> {
  var myRequest;
  ...
  @override
  void initState() {
    APISearch apiSearch = APISearch(platformCode: widget.consoleIndex);
